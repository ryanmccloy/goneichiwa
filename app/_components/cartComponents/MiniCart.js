...
export default function MiniCart({ handleClose, isVisible }) {
  ...
  const handleViewCartClick = () => {
    handleClose(); // ✅ close the minicart
    router.push("/cart"); // ✅ programmatic navigation
  };
          ...
          {isEmpty ? (
            ...
            <>
              ...
              <button
                ...
                className="block mt-15 bg-accent-blue text-off-black text-center py-2 px-4 rounded-global text-sm w-full cursor-pointer"
              >
                View Full Cart
              </button>
            </>
